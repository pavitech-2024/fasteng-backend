export const BINDER_TRIAL_MESSAGES = {
  ...
  MARSHALL_NOT_FOUND: 'Marshall not found',
  CALCULATING_BINDER_TRIAL: 'Calculating Marshall initial binder trial',
  SAVING_STEP_4: 'Saving Marshall binder trial step 4',
  FETCHING_TEMPERATURES: 'Error fetching bands of temperatures'
};