...
var CompressionController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CompressionController = void 0;
const common_1 = require("@nestjs/common");
const service_1 = require("../service");
const swagger_1 = require("@nestjs/swagger");
const compression_init_dto_1 = require("../dto/compression-init.dto");
const calc_compression_dto_1 = require("../dto/calc.compression.dto");
let CompressionController = CompressionController_1 = class CompressionController {
    constructor(compressionService) {
        this.compressionService = compressionService;
        this.logger = new common_1.Logger(CompressionController_1.name);
    }
    verifyInitCompression(response, body) {
        return __awaiter(this, void 0, void 0, function* () {
            this.logger.log('verify init compression > [body]');
            const status = yield this.compressionService.verifyInitCompression(body);
    ...
    calculateCompression(body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const compression = yield this.compressionService.calculateCompression(body);
            if (compression.success)
                this.logger.log('calculate compression > [success]');
            else
                this.logger.error('calculate compression > [error]');
            return compression;
        });
    }
    saveEssay(response, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const compression = yield this.compressionService.saveEssay(body);
            if (compression.success)
                this.logger.log('save compression essay > [success]');
            else
                this.logger.error('save compression essay > [error]');
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, compression_init_dto_1.CompressionInitDto]),
    __metadata("design:returntype", Promise)
], CompressionController.prototype, "verifyInitCompression", null);
__decorate([
    (0, common_1.Post)('calculate-results'),
    (0, swagger_1.ApiOperation)({ summary: 'Calcula os resultados do ensaio de compactação com os dados enviados.' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [calc_compression_dto_1.Calc_Compression_Dto]),
    __metadata("design:returntype", Promise)
], CompressionController.prototype, "calculateCompression", null);
__decorate([
    (0, common_1.Post)('save-essay'),
    (0, swagger_1.ApiOperation)({ summary: 'Se possível, salva os dados do ensaio de compactação no banco de dados.' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Erro ao salvar os dados do ensaio de compactação no banco de dados.' }),
    __param(0, (0, common_1.Res)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
