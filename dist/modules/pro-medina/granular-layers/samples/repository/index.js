...
exports.GranularLayers_SamplesRepository = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const database_config_1 = require("../../../../../infra/mongoose/database.config");
const mongoose_2 = require("mongoose");
const schemas_1 = require("../schemas");
let GranularLayers_SamplesRepository = class GranularLayers_SamplesRepository {
    constructor(granularLayers_sampleModel) {
        this.granularLayers_sampleModel = granularLayers_sampleModel;
    }
    create(granularLayers_sample) {
    ...
    findAllByFilter(queryFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const docs = yield this.granularLayers_sampleModel
                .find(query)
                .sort({ createdAt: -1 })
            ...
            const count = yield this.granularLayers_sampleModel.countDocuments(countQuery);
            let totalPages;
            if (need_count) {
    ...
    findOne(granularLayers_samplesFilterQuery) {
        return __awaiter(this, void 0, void 0, function* () {
            const { name } = granularLayers_samplesFilterQuery;
            const sample = yield this.granularLayers_sampleModel.findOne({ 'generalData.name': name });
            return sample;
        });
    }
    findOneById(sampleId) {
        return __awaiter(this, void 0, void 0, function* () {
            const sample = yield this.granularLayers_sampleModel.findById(sampleId);
            return sample;
        });
    }
    findOneAndUpdate(granularLayers_samplesFilterQuery, granularLayers_sample) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    findOneAndDelete(granularLayers_samplesFilterQuery) {
        return __awaiter(this, void 0, void 0, function* () {
