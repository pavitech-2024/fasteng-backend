...
export declare class MarshallController {
    ...
    getStep3Data(response: Response, body: MarshallStep3Dto): Promise<Response<any, Record<string, any>>>;
    calculateStep3Data(response: Response, body: CalculateStep3DTO): Promise<Response<Step3Result>>;
    saveGranulometryCompositionStep(response: Response, userId: string, body: SaveStep3DTO): Promise<Response<any, Record<string, any>>>;
    calculateStep4Data(response: Response, body: any): Promise<Response<any, Record<string, any>>>;
    saveBinderTrialStep(response: Response, userId: string, body: SaveStep4DTO): Promise<Response<any, Record<string, any>>>;
    ...
    saveOptimumBinderContentData(response: Response, userId: string, body: SaveStep7DTO): Promise<Response<any, Record<string, any>>>;
    ...
    saveConfirmationCompressionData(response: Response, userId: string, body: SaveStep8DTO): Promise<Response<any, Record<string, any>>>;
    saveStepData(response: Response, body: SaveStepDTO): Promise<Response<any, Record<string, any>>>;
}
