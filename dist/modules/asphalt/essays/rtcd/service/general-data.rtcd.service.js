...
var GeneralData_Rtcd_Service_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.GeneralData_Rtcd_Service = void 0;
const common_1 = require("@nestjs/common");
const repository_1 = require("../../../../../modules/asphalt/materials/repository");
const exceptions_1 = require("../../../../../utils/exceptions");
const repository_2 = require("../repository");
let GeneralData_Rtcd_Service = GeneralData_Rtcd_Service_1 = class GeneralData_Rtcd_Service {
    constructor(rtcdRepository, materialsRepository) {
    ...
    verifyInitRtcd({ name }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (rtcdExists)
                    throw new exceptions_1.AlreadyExists(`Rtcd with name "${name}`);
                return true;
            }
            catch (error) {
                throw error;
