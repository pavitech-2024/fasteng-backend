...
var GeneralData_ElasticRecovery_Service_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.GeneralData_ElasticRecovery_Service = void 0;
const common_1 = require("@nestjs/common");
const repository_1 = require("../repository");
const repository_2 = require("../../../materials/repository");
const exceptions_1 = require("../../../../../utils/exceptions");
let GeneralData_ElasticRecovery_Service = GeneralData_ElasticRecovery_Service_1 = class GeneralData_ElasticRecovery_Service {
    ...
    verifyInitElasticRecovery(_a) {
        return __awaiter(this, arguments, void 0, function* ({ name, material }) {
            try {
                ...
                if (!materialExists)
                    throw new exceptions_1.NotFound('Chosen material of ElasticRecovery');
                const elasticRecoveryExists = yield this.elasticRecoveryRepository.findOne({
                    "generalData.name": name,
                    "generalData.material._id": material._id
                });
                if (elasticRecoveryExists)
