...
var Calc_Igg_Service_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Calc_Igg_Service = void 0;
const common_1 = require("@nestjs/common");
const repository_1 = require("../repository");
let Calc_Igg_Service = Calc_Igg_Service_1 = class Calc_Igg_Service {
    constructor(iggRepository) {
            ...
            try {
                ...
                dados.forEach((segmento) => {
                    ...
                    for (let i = 0; i < segmento.length; i++) {
                        ...
                        tri += segmento[i][22];
                        tre += segmento[i][23];
                        treQuadrado += Math.pow(segmento[i][23], 2);
                        triQuadrado += Math.pow(segmento[i][22], 2);
                    }
                    ...
                    const varianciaTri = mediaTriQuadrado - Math.pow(mediaTri, 2);
                    const varianciaTre = mediaTreQuadrado - Math.pow(mediaTre, 2);
