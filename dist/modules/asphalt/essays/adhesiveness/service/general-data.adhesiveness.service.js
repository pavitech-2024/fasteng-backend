...
var GeneralData_Adhesiveness_Service_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.GeneralData_Adhesiveness_Service = void 0;
const common_1 = require("@nestjs/common");
const repository_1 = require("../../../materials/repository");
const exceptions_1 = require("../../../../../utils/exceptions");
const repository_2 = require("../repository");
let GeneralData_Adhesiveness_Service = GeneralData_Adhesiveness_Service_1 = class GeneralData_Adhesiveness_Service {
    constructor(adhesivenessRepository, materialsRepository) {
    ...
    verifyInitAdhesiveness({ name, material }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!materialExists)
                    throw new exceptions_1.NotFound('Chosen material of Adhesiveness');
                const adhesivenessExists = yield this.adhesivenessRepository.findOne({
                    generalData: { name, material: { _id: material._id } },
                });
                if (adhesivenessExists)
                    throw new exceptions_1.AlreadyExists(`Adhesiveness with name "${name} from user "${material.userId}"`);
                return true;
            }
            catch (error) {
                throw error;
