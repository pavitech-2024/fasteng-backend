...
let MaterialsRepository = class MaterialsRepository {
    ...
    findByType(types, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const materials = yield this.materialModel.find({
                "userId": userId,
                "type": types
            }).sort({ createdAt: -1 });
            ;
    ...
    findSelectedById(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.materialModel.find({ _id: { $in: ids } }).exec();
        });
    }
    findByUserId(materialsFilterQuery) {
        return __awaiter(this, void 0, void 0, function* () {
            const materials = yield this.materialModel.find(materialsFilterQuery).sort({ createdAt: -1 });
            return materials;
        });
    }
    ...
    findOneAndDelete(materialsFilterQuery) {
        return __awaiter(this, void 0, void 0, function* () {
