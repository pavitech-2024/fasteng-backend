...
const materials_module_1 = require("./modules/asphalt/materials/materials.module");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        swagger_1.SwaggerModule.setup('docs/asphalt', app, swagger_1.SwaggerModule.createDocument(app, swagger_asphalt, {
            include: [auth_module_1.AuthModule, users_module_1.UsersModule, materials_module_1.MaterialsModule],
        }));
